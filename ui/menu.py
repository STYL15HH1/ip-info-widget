...
def build_context_menu(root: tk.Tk, refresh: Callable[[], None], test_connection: Callable[[], None], hide: Callable[[], None], history: Callable[[], None], settings: Callable[[], None], quit_app: Callable[[], None]) -> tk.Menu:
